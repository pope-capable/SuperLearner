...
import classic from '../assets/images/micon.png'
...
function Models() {
    ...
    function showPFolders (projectId, projectName) {
        window.location.href = `/models-compare/${projectId}/${projectName}`
    }
                ...
                <div>
                    ...
                    <div className = "hold-3">
                        {data.projects.map((item, index) => (
                            <div onClick = {() => showPFolders(item.project.id, item.project.title)} className = "project-mile">
